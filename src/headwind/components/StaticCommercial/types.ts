// export type definitions for non-npm package Google Publisher Tag (DoubleClick GPT 20220315) 2.0
...
export namespace GoogleTag {
   ...
   * ```
   */
  export type apiReady = boolean | undefined;
  /**
   ...
   * ```
   */
  export type cmd = CommandArray | Array<(this: typeof globalThis) => void>;
  /**
   ...
   */
  export type pubadsReady = boolean | undefined;
  /**
   * Returns a reference to the {@link CompanionAdsService}.
   * @returns The Companion Ads service.
   */
  export type companionAds = () => CompanionAdsService;
  /**
   ...
   */
  export type defineOutOfPageSlot =
    | ((adUnitPath: string, div: string | enums.OutOfPageFormat) => Slot | null)
    | ((adUnitPath: string) => Slot);
  // export type defineOutOfPageSlot =
  /**
  ...
  export type defineSlot =
    | ((adUnitPath: string, size: GeneralSize, div: string) => Slot | null)
    | ((adUnitPath: string, size: GeneralSize) => Slot);
  /**
   ...
   */
  export type destroySlots = (slots?: Slot[]) => boolean;
  /**
   ...
   */
  export type disablePublisherConsole = () => void;
  /**
   ...
   */
  export type display = (divOrSlot: string | Slot | Element) => void;
  /**
   * Enables all GPT services that have been defined for ad slots on the page.
   */
  export type enableServices = () => void;
  /**
   ...
   */
  export type setAdIframeTitle = (title: string) => void;
  /**
   ...
   */
  export type sizeMapping = () => SizeMappingBuilder;
  /**
  ...
  export interface PubAdsService extends Service {
     ...
     * - However, if set to `false` or left unspecified, the ad will be rendered using a SafeFrame container depending on the export type of creative and the selection made in the Google Ad Manager UI
  ...
  /**
   * Public export interface for ResponseInformation.
   */
  ...
  export interface RewardedPayload {
    ...
    amount: number;
    /**
     * The export type of item included in the reward (for example, "coin").
     */
    type: string;
  }
  /**
  ...
  export interface Service {
     ...
     *
     * An object of the appropriate event export type is passed to the listener when it is called.
     *
     * **Example**
     * ```
     ...
     * ```
     *
     * @param eventexport type A string representing the export type of event generated by GPT. Event types are case sensitive.
  ...
  namespace adsense {
     ...
     * | adsense_ad_types         | google_ad_export type      | text_image          | text, image, text_image                                                                                    |
  ...
  export namespace events {
    /**
     * Event export type for all GPT events.
     */
    ...
    /**
     * Base export interface for all GPT events. All GPT events below will have the following fields.
     */
    ...
    export interface ImpressionViewableEvent extends Event {}
    /**
     ...
     */
    // tslint:disable-next-line:no-empty-interface
    export interface RewardedSlotClosedEvent extends Event {}
    /**
     ...
     * ```
     */
    export interface RewardedSlotGrantedEvent extends Event {
      /**
     ...
     * ```
     */
    export interface RewardedSlotReadyEvent extends Event {
      /**
     ...
     */
    // tslint:disable-next-line:no-empty-interface
    export interface SlotOnloadEvent extends Event {}
    /**
     ...
     * ```
     */
    export interface SlotRenderEndedEvent extends Event {
      /**
     ...
     */
    // tslint:disable-next-line:no-empty-interface
    export interface SlotRequestedEvent extends Event {}
    /**
     ...
     */
    // tslint:disable-next-line:no-empty-interface
    export interface SlotResponseReceived extends Event {}
    /**
     ...
     * ```
     */
    export interface SlotVisibilityChangedEvent extends Event {
      /**
